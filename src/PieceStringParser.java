...
public class PieceStringParser {
    ...
    static LinkedList<Integer> parsePieces(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            switch (c) {
                case 'I':
                    result.add(TetrisPiece.I_PIECE);
                    break;
                case 'O':
                    result.add(TetrisPiece.O_PIECE);
                    break;
                case 'S':
                    result.add(TetrisPiece.S_PIECE);
                    break;
                case 'Z':
                    result.add(TetrisPiece.Z_PIECE);
                    break;
                case 'T':
                    result.add(TetrisPiece.T_PIECE);
                    break;
                case 'J':
                    result.add(TetrisPiece.J_PIECE);
                    break;
                case 'L':
                    result.add(TetrisPiece.L_PIECE);
                    break;
